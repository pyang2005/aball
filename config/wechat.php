...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx9d2b3c68d5f71f5c'),         // AppID
    'secret'  => env('WECHAT_SECRET', '19dbeaf2f4d0e2510f9cf095e72b8e8a'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'ExveyAu4PfHxW'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'ExveyAu4PfHxWydmrbSdHdAnmJng9mJuqTSIc55L4mO'),                    // EncodingAESKey
